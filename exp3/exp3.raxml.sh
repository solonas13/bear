#!/bin/bash
 ...
 rm RAxML_p*
 rm RAxML_r*
 ./raxmlHPC-PTHREADS-SSE3 -m GTRCAT -n 50.2500.35.cyc -p 12345 -s 50.2500.35.aln.cyc
 rm RAxML_i*
 rm RAxML_l*
 rm RAxML_p*
 rm RAxML_r*

 cat RAxML_bestTree.50.2500.35.true RAxML_bestTree.50.2500.35.bear RAxML_bestTree.50.2500.35.nobear RAxML_bestTree.50.2500.35.cyc > 50.2500.35.allTrees
